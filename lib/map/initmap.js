...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [
                    ["https://khms0.googleapis.com/kh?v=713&hl=es-ES&", "https://khms1.googleapis.com/kh?v=713&hl=es-ES&"], null, null, null, 1, "713", ["https://khms0.google.com/kh?v=713&hl=es-ES&", "https://khms1.google.com/kh?v=713&hl=es-ES&"]
                ], null, null, null, null, [
                    ["https://cbks0.googleapis.com/cbk?", "https://cbks1.googleapis.com/cbk?"]
                ],
                [
                    ["https://khms0.googleapis.com/kh?v=102&hl=es-ES&", "https://khms1.googleapis.com/kh?v=102&hl=es-ES&"], null, null, null, null, "102", ["https://khms0.google.com/kh?v=102&hl=es-ES&", "https://khms1.google.com/kh?v=102&hl=es-ES&"]
                ],
                [
            ...
            ["https://maps.googleapis.com/maps-api-v3/api/js/27/9/intl/es_ALL", "3.27.9"],
            [2676041246], 1, null, null, null, null, null, "initMap", null, null, 1, "https://khms.googleapis.com/mz?v=713&", "AIzaSyCCUGyA9r_721bKHgUFDqUY79EXZrt-ABs", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [
            ...
            ["https://www.google.com/maps/api/js/master?pb=!1m2!1u27!2s9!2ses-ES!3sUS!4s27/9/intl/es_ALL", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u27!2s9!2ses-ES"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, [null, null, null, null, null, null, null, null, null, [0, 0]], null, [],
            ["27.9"]
        ], loadScriptTime);
    };
...
(function(_) {
    ...
    Nd.prototype.set = function(a, b) {
        if (null != b && !(b && _.x(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply)) throw Error("Valor esperado al implementar google.maps.MapType");
